"""add ignored recommendation regions"""
...
def upgrade() -> None:
    op.create_table(
        "ignored_recommendation_regions",
        ...
        sa.PrimaryKeyConstraint("guild_id", "region_id"),
    )


def downgrade() -> None:
    op.drop_table("ignored_recommendation_regions")
